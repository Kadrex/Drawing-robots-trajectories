...
This version starts drawing new punch on trajectories from the exact same point as the first ones.
"""
...
class Good:
    ...
    def __init__(self):
        ...
        self.very_first_starting_point = []
    ...
    def draw_arcs(self, data: list):
        ...
        if not self.very_first_starting_point:
            if len(data) > 0:
                self.very_first_starting_point = [self.circle_center[0] - data[0][1], self.circle_center[1]]
        for i in range(len(data)):
            ...
            if not i:
                ...
                self.starting_point = self.very_first_starting_point
                self.circle_center = [self.very_first_starting_point[0] + self.radius, self.very_first_starting_point[1]]
            else:
...
if __name__ == '__main__':
    drawing = Good()
    #polygons = [[(0, 0), (1, 0), (1, 1), (0, 1), (0, 0)], [(10, 10), (11, 10), (11, 11), (10, 11), (10, 10)]]
    ...
    drawing.draw_arcs([[0.2, 0.8], [0.5, -0.9]])
